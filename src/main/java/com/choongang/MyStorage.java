...
public class MyStorage {
    ...
    static void prod_input(Scanner s){
        ...
        // TODO:
        /**
         * 등록하고 싶은 제품명을 입력하라는 출력문.
         * 입력받은 값을 받을 변수 생성.
         * for문으로 배열의 길이만큼 순회
         * 0부터 길이만큼 순회 하면서 EMPTY 라는 요소가 있다면, 사용자가 입력한 제품명을 EMPTY 와 교체.
         */
    ...
    public static void prod_amount_add(Scanner s) {
        ...
        int finalNum = 0;
        finalNum = Integer.parseInt(test);
        counts[foundIdx] += finalNum;  // 제품의 수량을 증가
